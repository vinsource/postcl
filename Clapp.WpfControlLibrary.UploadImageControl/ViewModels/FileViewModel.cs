...
namespace Clapp.WpfControlLibrary.UploadImageControl.ViewModels
{
    public class FileViewModel :  INotifyPropertyChanged
    {
        ...
        public FileViewModel(UploadViewModel viewModel, long length, string fileName, BitmapImage imageSource, Stream fileInfo)
            : this(viewModel, length, fileName, imageSource)
        {
            FileInfo = fileInfo;
        }

        private Stream _fileInfo;
        public Stream FileInfo
        {
