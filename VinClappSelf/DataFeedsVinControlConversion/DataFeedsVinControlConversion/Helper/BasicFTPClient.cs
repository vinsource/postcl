...
namespace DataFeedsVinControlConversion
{
    public class BasicFTPClient
    {
        ...
        public FtpClient cl = new FtpClient();
        ...
        public BasicFTPClient()
        {
            ...
            //cl2 = new FtpClient(Username, Password, Host);

            //cl2.Connect(Username, Password, Host, Port);
        ...
        public BasicFTPClient(string theHost)
        {

            if (theHost.Equals("iPage"))
            {
                ...
                cl = new FtpClient(Username, Password, Host, Port);
            }
            else if (theHost.Equals("in motion"))
            {
                Username = System.Configuration.ConfigurationManager.AppSettings["UsernameFTPInMotion"].ToString();

                Password = System.Configuration.ConfigurationManager.AppSettings["PasswordFTPInMotion"].ToString();

                Port = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["PortFtpInMotion"].ToString());

                //Host = theHost;
                Host = System.Configuration.ConfigurationManager.AppSettings["HostFtpInMotion"].ToString();
            ...
            else if (theHost.Equals("whitman"))
            {
                Username = System.Configuration.ConfigurationManager.AppSettings["WhitmanFTPUsername"].ToString();

                Password = System.Configuration.ConfigurationManager.AppSettings["WhitmaFTPPassword"].ToString();

                Port = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["WhitmaFTPPort"].ToString());

                //Host = theHost;
                Host = System.Configuration.ConfigurationManager.AppSettings["WhitmaFTPHost"].ToString();
            ...
            else if (theHost.Equals("vinwindow"))
            {
                Username = System.Configuration.ConfigurationManager.AppSettings["FTPVinwindowUsername"].ToString();

                Password = System.Configuration.ConfigurationManager.AppSettings["FTPVinwindowPassword"].ToString();

                Port =
                    Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["FTPVinwindowPort"].ToString());

                Host = System.Configuration.ConfigurationManager.AppSettings["FTPVinwindowHost"].ToString();
        ...
        public void Upload(XmlNode node, Stream stream, string Path, string FileName)
        {
            string[] pathSub = Path.Split(new String[] { "/" }, StringSplitOptions.None);

            string workingDir = "/" + node.Attributes["WorkingDir"].Value;

            cl.SetWorkingDirectory(node.Attributes["WorkingDir"].Value);
        ...
        public void UploadVinControl(string folderPath, Stream stream, string Path, string FileName)
        {
            string[] pathSub = Path.Split(new String[] { "/" }, StringSplitOptions.None);
