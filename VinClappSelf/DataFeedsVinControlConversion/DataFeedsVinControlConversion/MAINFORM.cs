...
namespace DataFeedsVinControlConversion
{
    public partial class MAINFORM : Form
    {
        ...
        private void Button4Click(object sender, EventArgs e)
        {
            ...
            if (DID == 15896 || DID == 15986  || DID == 2650 || DID==115896)
                path = "/15896" + ".txt";
            ...
            if (csv != null)
            {
                ...
                if (DID == 15896)
                {
                    ...
                    foreach (DataRow drRow in dtTemporaryNoheader.Rows)
                    {
                        ...
                        int mileageReturn = 0;
                        Int32.TryParse(drRow.Field<string>(7), out mileageReturn);
                        if (!drRow.Field<string>(3).ToLower().Contains("smart") &&
                            !String.IsNullOrEmpty(drRow.Field<string>(4)) && mileageReturn > 500 &&
                            !drRow.Field<string>(4).Contains("Sprinter"))
                        {
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            ...
            var tttt =
                context.whitmanenterpriseappraisal.Where(
        ...
        private void button25_Click(object sender, EventArgs e)
        {
            ...
            var result = context.whitmanenterprisedealershipinventory.Where(x => x.DealershipId == DID && x.Recon ==true).ToList();

            //foreach (var tmp in result)
            //{
            //    hashSet.Add(tmp.StockNumber);
            ...
            foreach (var tmp in result)
            {
                if (!hashSet.Contains(tmp.StockNumber))
                    hashSet.Add(tmp.StockNumber);
                else
                {
...
//            dataGridView1.DataSource = chartGraph.ChartModels;
        ...
        private void EMAIL_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var message = new MailMessage(fromAddress, new MailAddress("travis@vincontrol.com"));
                ...
                message.Subject = "VINCLAPP FULL SERVICE  - " + "TEST";

                var client = new SmtpClient(smtpServerAddress, 3535);
