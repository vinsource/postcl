...
namespace Vinclapp.Craigslist
{
    public class VehicleInfo
    {
        ...
        public string PostingCityName { get; set; }
        ...
        public int AdsPoistion { get; set; }

        public int ProgessStatus { get; set; }

        public string DealerWebUrl { get; set; }
